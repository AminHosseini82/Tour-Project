...
def create_tourism_massages(to_email, new_tourism):
    subject = 'ساخت یک گردشگری جدید✔'
    # دریافت زمان فعلی
    ...
    context = {
        "new_tourism": new_tourism,
        "current_time": current_time,
        "formatted_time": formatted_jdate
    }

    html_message = render_to_string('tourism/email_sending/createTourism_email.html', context)
